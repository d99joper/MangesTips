<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NyKupong.aspx.cs" Inherits="VMTips_2018.NyKupong" %>
        ...
        <fieldset>
            ...
            <div id="header">
                ...
                <div style="float:right;padding:5px 5px 5px 5px;width:400px;">
                    ...
                    <a href="Docs/vmtipset2018.docx">Klicka här!</a>   
                    <br /><br />
                    <div id="rightside">
