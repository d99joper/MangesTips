<%@ Page Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="VMTips_2018.Admin.Default" ValidateRequest="false" %>
...
<asp:Content ID="cntMain" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="wrap">
        ...
        <div class="rightside">
            <img src="../images/loggo2018.png" alt="Manges VM-tips" />
